...
return [
    ...
    'are_you_sure_you_want_to_delete_member' => ' Tem certeza de que deseja excluir este membro da equipe?',
    'are_you_sure_you_want_to_delete_team' => 'Tem certeza de que deseja excluir esta equipe?',
    'are_you_sure_you_want_to_leave_team' => 'Tem certeza que deseja sair desta equipe?',
    ...
    'country' => 'O campo :attribute não é um país válido.',
    'create_team' => 'Criar Equipe',
    'current_password' => 'A senha está incorreta.',
    'current_teams' => ' Equipes Atuais',
    ...
    'if_you_delete_team_all_data_will_be_deleted' => 'Se você optar por excluir a equipe, todos os dados serão excluídos permanentemente.',
    ...
    'looks_like_you_are_not_part_of_team' => 'Parece que você não faz parte de nenhum equipe!',
    ...
    'next' => 'Próxima &raquo;',
    'not_eligible_based_on_current_members_teams' => 'Você não é elegível para este plano com base no número atual de equipes / membros da equipe.',
    ...
    'plan_allows_no_more_teams' => 'Seu plano atual não permite que você crie mais equipes',
    'please_upgrade_to_add_more_members' => ' Atualize sua assinatura para adicionar mais membros à equipe.',
    'please_upgrade_to_create_more_teams' => 'Atualize sua assinatura para criar mais equipes.',
    ...
    'slug_input_explanation' => 'Este slug é usado para identificar sua equipe em URLs.',
    ...
    'team_name_was_updated' => ' O nome da sua equipe foi atualizado!',
    ...
    'you_have_x_invitations_remaining' => ' No momento, você tem :count convite(s) restante(s).',
