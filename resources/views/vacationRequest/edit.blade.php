...
<div class="card mb-4 shadow">
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('vacationRequest.update', $data->id) }}" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="mb-3">
      ...
      <div class="mb-3 mt-3">
        ...
        <textarea name="reason" id="reason" rows="4" class="form-control">{{ $data->reason }}</textarea>
      </div>
      <div class="mb-3">
