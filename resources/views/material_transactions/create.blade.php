...
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <form method="POST" action="{{ route("materials.transactions.{$type}.store",['category'=>$category]) }}" enctype="multipart/form-data">
          @csrf
          <div class="row gx-3">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="date" name="TransactionDate" class="form-control" value="{{ old('TransactionDate', date('Y-m-d')) }}" required>
            </div>
            <div class="col-md-3 mb-3">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="OriginOrDestination" class="form-control" value="{{ old('OriginOrDestination') }}" required>
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="text-center">
            ...
            <a href="{{ route('materials.transactions.index',['category'=>$category]) }}" class="btn btn-secondary ms-2">Cancelar</a>
            </div>
        </form>
      </div>
    </div>
