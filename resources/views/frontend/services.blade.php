...
<body>
    ...
    <div class="site-main">
                        ...
                        <div class="pl-70 res-991-pl-0 res-991-mt-30">
                            ...
                            <div class="section-title pr-55 res-991-pr-0 clearfix">
                                <div class="title-header">
                                    <h5>CONSULTANCY</h5>
                                    <h2 class="title">High Quality Solutions</h2>
                                </div>
                                <div class="title-desc">To obtain higher performance, Our leaders first identify the critical obstacles to forward progress and then develop a coherent approach to overcoming them. We define your company mission and prioritize company objectives.</div>
                            ...
                            <div class="row no-gutters mt-40">
                                    ...
                                    <div class="featured-icon-box left-icon icon-align-top">
                                        ...
                                        <div class="featured-content"><!-- featured-content-->
                                            <div class="featured-title"><!-- featured-title-->
                                                <h5 class="mb-5">Advanced Analytics</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="featured-icon-box left-icon icon-align-top">
                                        ...
                                        <div class="featured-content"><!-- featured-content-->
                                            <div class="featured-title"><!-- featured-title-->
                                                <h5 class="mb-5">Private Equity</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row no-gutters">
                                <div class="col-sm-6">
                                    <div class="featured-icon-box left-icon icon-align-top">
                                        ...
                                        <div class="featured-content"><!-- featured-content-->
                                            <div class="featured-title"><!-- featured-title-->
                                                <h5 class="mb-5">Corporate Finance</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="featured-icon-box left-icon icon-align-top">
                                        ...
                                        <div class="featured-content"><!-- featured-content-->
                                            <div class="featured-title"><!-- featured-title-->
                                                <h5 class="mb-5">Chain Management</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-45">
                                <div class="col-md-5">
                                    ...
                                    <div class="ttm_single_image-wrapper ttm-991-center">
                                        <img class="img-fluid" src="images/single-img-fourteen.jpg" title="single-img-fourteen" alt="single-img-fourteen">
                                    </div><!-- ttm_single_image-wrapper end -->
                                </div>
                                <div class="col-md-7">
                                    <div class="featured-content res-767-mt-30"><!-- featured-content-->
                                        <div class="featured-title"><!-- featured-title-->
                                            <h5 class="mb-5">Protect your business</h5>
                                        </div>
                                        <div class="featured-desc pr-30"><!-- featured-desc-->
                                            <p>He found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, Sed ut unde omnis natus error sit lorem voluptatem doloremque.</p>
                                        </div>
        ...
        <!-- row-title-section -->
        <section class="ttm-row ttm-bgcolor-darkgrey ttm-bg ttm-bgimage-yes bg-img2 row-title3-section clearfix">
                ...
                <div class="row">
                        ...
                        <div class="ttm-pricing-plan box-shadow text-center clearfix">
                            ...
                            <div class="ttm-ptablebox-content">
                                <div class="ttm-ptablebox-price-w">
                                    ...
                                    <div class="ttm-ptablebox-price">69</div>
                                    <div class="ttm-ptablebox-frequency">mo</div>
                                </div>
                            ...
                            <div class="price_btn">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-bgcolor-darkgrey mb-20" href="#">choose plan</a>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="ttm-pricing-plan box-shadow2 text-center clearfix">
                            ...
                            <div class="price_btn">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-bgcolor-skincolor mb-20" href="#">choose plan</a>
                            </div>
                        </div><!--ttm-pricing-plan-->
                    </div>
                    <div class="col-md-4">
