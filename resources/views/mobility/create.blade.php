...
@section('title', 'Nova Mobility')@section('title', 'Nova Mobility')
@section('content')
...
<div class="card my-4 shadow">
  ...
  <div class="card-body">
    ...
    <form action="{{ route('mobility.searchEmployee') }}" method="GET" class="mb-4">    <form action="{{ route('mobility.searchEmployee') }}" method="GET" class="mb-4">
      <div class="row g-3">
        <div class="col-md-4">
    ...
    @isset($employee)
      <hr>
      <form action="{{ route('mobility.store') }}" method="POST">      <form action="{{ route('mobility.store') }}" method="POST">
        @csrf
        ...
        <div class="container">
            ...
            <div class="row">
              <!-- Coluna da esquerda: Nome e Contacto -->
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea name="causeOfMobility" rows="3" class="form-control">{{ old('causeOfMobility') }}</textarea>                  <textarea name="causeOfMobility" rows="3" class="form-control">{{ old('causeOfMobility') }}</textarea>
                </div>
              </div>
            </div>
